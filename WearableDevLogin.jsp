            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        <div class="panel-heading">
                          <div style="color: purple" > <b>   WEARABLE LOGIN FORM   </b></div>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="WearableDeviceLoginController" method="get">
                                        <div class="form-group">
                                            <label>Enter Wearable Device ID</label>
                                  ...
                                  <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                   <a href="WearableDevForgetPassword.jsp" >Forget password ? </a> 
                                            </span>
                                        </div>
                                    <div><input type="Reset" class="btn btn-danger"  value="Reset">
                                        <input type="submit" name="submit" class="btn btn-primary " value="Login"></div>
                                    <hr />
<!--                                     Not register ? <a href="register.jsp" >click here Registration</a> or go to <a href="index.jsp">Home</a> 
 -->                                    </form>
                            </div>
