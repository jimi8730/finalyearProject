 ...
 String name=(String) session.getAttribute("User");                
             ...
             <div style="color:Green;" ><h3><center>Welcome <%=name %></center> </h3></div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                 ...
                 <div style="color: purple"> User Name   </div>
                   <div style="color: purple"> User Address    :  </div>
                 <div style="color: purple"> User Email  :  </div>
             <div style="color: purple"> User Mobile No :  </div>
                 <div style="color: purple"> User Gender :  </div>
                 <div style="color: purple"> User Image  :  </div>
       </div>
                 <div class="col-md-4 col-sm-6 col-xs-12">
                 ...
                 <img src="ProfileImage.jsp" class="img-circle" alt="Cinque Terre" width="100" height="100">
                  ...
                  <div>.<hr></div>
                 <center> <h3><a href="UserProfileUpdate.jsp">Edit Profile</a></center></h3>

                </form>
                  <%--  <div style="color: purple"> Image id :  <%=rs.getString(1)%> </div>
                    <div style="color: purple"> Image name : <%=rs.getString(2)%> </div>
                     <div style="color: purple"> Image detail : <%=rs.getString(3)%> </div>
                      <div style="color: purple"> Image use : <%=rs.getString(4)%> </div>
                       <div style="color: purple"> Image color : <%=rs.getString(5)%> </div> --%>
               </div>
