 ...
 %>
         ...
         <div style="border: activeborder;"  class="col-md-12 col-sm-12 col-xs-12">
                 ...
                 <TABLE class="table table-hover ">
         			...
         			CloudDAO dao1=new CloudDAO();
             
         					ResultSet rs=dao1.viewInfo();
				...
				{ 
               	...
               	<%-- <TD> <a href="DoctorAddMI.jsp?Name=<%= rs.getString(2)%>&Email=<%= rs.getString(3)%>&Bp=<%= rs.getString(4) %>&Hb=<%= rs.getString(5)%>&Temp=<%= rs.getString(6)%>&Address=<%= rs.getString(7) %>&MobileNo=<%= rs.getString(8)%>&Gender=<%= rs.getString(9)%> %>">View</a></TD>
                --%>	
