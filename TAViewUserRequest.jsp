 ...
 %>
         ...
         <div style="border: activeborder;"  class="col-md-12 col-sm-12 col-xs-12">
                 ...
                 <TABLE class="table table-hover ">
         			...
         			TADAO dao1=new TADAO();
             ResultSet rs=dao1.viewUserRequest();
				...
				{ 
           		...
           		<TR>
           			...
           			<TD> <a href="TAController?UserName=<%= rs.getString(2)%>&RequestUserName=<%= rs.getString(3)%>">Check Symptoms</a></TD>
