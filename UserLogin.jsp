            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        <div class="panel-heading">
                          <div style="color: purple" > <b>   USER LOGIN FORM   </b></div>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="UserLoginController" method="get">
                                        <div class="form-group">
                                            <label>Enter User Email</label>
                                            <input class="form-control" type="text" name="UserName" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Example: john.smith@gmail.com" required>
                                         
                                        </div>
                                  <div class="form-group">
                                            <label>Enter Password</label>
                                            <input class="form-control" type="password" name="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Example: Abcdsd@123" required>
                            </div>
                                          <div class="form-group">
                                    ...
                                    <hr />
                                    Not register ? <a href="UserRegistration.jsp" >click here Registration</a> or go to <a href="index.jsp">Home</a> 
                                    </form>
                            </div>
