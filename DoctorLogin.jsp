            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        <div class="panel-heading">
                          <div style="color: purple" > <b>   DOCTOR LOGIN FORM   </b></div>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="DoctorLoginController" method="get">
                                  ...
                                  <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                   <a href="DoctorForgetPassword.jsp" >Forget password ? </a> 
                                            </span>
                                        </div>
                                    ...
                                    <hr />
                          Not register ? <a href="DoctorRegister.jsp" >click here Registration</a> or go to <a href="index1.jsp">Home</a> 
