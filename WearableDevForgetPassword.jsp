            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        <div class="panel-heading">
                          <div style="color: purple" > <b>   WEARABLE DEVICE FORGOT FORM   </b></div>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="WearableDeviceLoginController" method="get">
                                        <div class="form-group">
                                            <label>Enter Wearable Email</label>
                                    ...
                                    <div><input type="Reset" class="btn btn-danger"  value="Reset">
                                        <input type="submit" name="submit" class="btn btn-primary " value="Forgot"></div>
                                    <hr />
