            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        <div class="panel-heading">
                          <div style="color: purple" > <b>   CLOUDLET LOGIN FORM   </b></div>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="CloudletLoginController" method="get">
                                        <div class="form-group">
                                            <label>Enter Cloudlet Email</label>
                                  ...
                                  <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                   <a href="CloudletForgetPassword.jsp" >Forget password ? </a> 
                                            </span>
                                        </div>
